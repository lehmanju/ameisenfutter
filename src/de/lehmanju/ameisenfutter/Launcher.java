...
public class Launcher extends Application implements EventHandler<WorkerStateEvent> {
	...
	public void start(Stage stage) throws Exception {
		...
		loader.load();
		reset(100, new int[] { 500, 500 }, new int[] { 251, 251 }, 5, 1000, 1);
	...
	public void resetSimulation() {
		reset(sp.ameisen, new int[] { sp.groesseX, sp.groesseY }, new int[] { sp.nestX, sp.nestY }, sp.futterStellen,
				sp.timeout, sp.iterations);
	}
	...
	public void reset(int ameisen, int[] groesse, int[] nest, int futterQ, int timeout, int iterations) {
		...
		simService.setPeriod(new Duration(1000));
	}
