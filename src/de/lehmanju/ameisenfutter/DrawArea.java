...
public class DrawArea implements EventHandler<MouseEvent> {
  ...
  public DrawArea(TitledPane p, Speicher sp, int width) {
    ...
    // Zeichne ein kleines Bild vom Hintergrund
    ...
    // setze Bild als Hintergrund und wiederhole es sooft es noetig ist, um die Flaeche zu fuellen
  ...
  public void handle(MouseEvent event) {
    ...
    if (x >= speicher.groesseX || y >= speicher.groesseY)
      return;
    String text;
    // Falls Mauszeiger ueber Nest, Futteranzahl = Futter im Nest
    if (x == speicher.nestX && y == speicher.nestY)
      text = "(X:" + x + ";Y:" + y + ") Ameisen: " + speicher.amVerteilung[x][y] + "; Futter: "
